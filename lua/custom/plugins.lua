...
local plugins = {
  ...
  },
  {
    ...
    enabled = true,
    config = function()
      local my_opts = require "custom.configs.gp-config"
      require("gp").setup(my_opts)
    end,
  },
  -- {
  --   "robitx/gp.nvim",
  ...
  --               .. "- Give the user short, direct and accurate answer.\n"
  --               .. "- Don't give me the code to setup environment and dependencies, just the summary.\n"
